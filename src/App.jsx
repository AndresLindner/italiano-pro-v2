    ...
    <div className="space-y-8">
      ...
      <section className="bg-indigo-50 p-6 rounded-xl border border-indigo-200">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border border-indigo-100">
            <div className="flex justify-between items-center border-b pb-2 mb-2">
              <h4 className="font-bold text-indigo-800">Vivere</h4>
              <PlayButton text="io vissi, tu vivesti, lui visse, noi vivemmo, voi viveste, loro vissero" size={15} />
            </div>
            <ul className="text-sm space-y-1.5">
              <li className="flex items-center justify-between"><span>io <strong>vissi</strong></span><PlayButton text="vissi" /></li>
              <li className="flex items-center justify-between"><span>tu vivesti</span><PlayButton text="vivesti" /></li>
              <li className="flex items-center justify-between"><span>lui/lei <strong>visse</strong></span><PlayButton text="visse" /></li>
              <li className="flex items-center justify-between"><span>noi vivemmo</span><PlayButton text="vivemmo" /></li>
              <li className="flex items-center justify-between"><span>voi viveste</span><PlayButton text="viveste" /></li>
              <li className="flex items-center justify-between"><span>loro <strong>vissero</strong></span><PlayButton text="vissero" /></li>
            </ul>
          </div>
          {/* Card Scegliere */}
          <div className="bg-white p-4 rounded-lg shadow-sm border border-indigo-100">
            <div className="flex justify-between items-center border-b pb-2 mb-2">
              <h4 className="font-bold text-indigo-800">Scegliere</h4>
              <PlayButton text="io scelsi, tu scegliesti, lui scelse, noi scegliemmo, voi sceglieste, loro scelsero" size={15} />
            </div>
            <ul className="text-sm space-y-1.5">
              <li className="flex items-center justify-between"><span>io <strong>scelsi</strong></span><PlayButton text="scelsi" /></li>
              <li className="flex items-center justify-between"><span>tu scegliesti</span><PlayButton text="scegliesti" /></li>
              <li className="flex items-center justify-between"><span>lui/lei <strong>scelse</strong></span><PlayButton text="scelse" /></li>
              <li className="flex items-center justify-between"><span>noi scegliemmo</span><PlayButton text="scegliemmo" /></li>
              <li className="flex items-center justify-between"><span>voi sceglieste</span><PlayButton text="sceglieste" /></li>
          ...
          <div className="bg-white p-4 rounded-lg shadow-sm border border-indigo-100">
            <div className="flex justify-between items-center border-b pb-2 mb-2">
              <h4 className="font-bold text-indigo-800">Cuocere</h4>
              <PlayButton text="io cossi, tu cuocesti, lui cosse, noi cuocemmo, voi cuoceste, loro cossero" size={15} />
            </div>
            <ul className="text-sm space-y-1.5">
              <li className="flex items-center justify-between"><span>io <strong>cossi</strong></span><PlayButton text="cossi" /></li>
              <li className="flex items-center justify-between"><span>tu cuocesti</span><PlayButton text="cuocesti" /></li>
              <li className="flex items-center justify-between"><span>lui/lei <strong>cosse</strong></span><PlayButton text="cosse" /></li>
